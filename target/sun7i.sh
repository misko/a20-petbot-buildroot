...
cp -prf ${LICHEE_BR_OUT}/external-toolchain/arm-linux-gnueabihf/libc/lib/arm-linux-gnueabihf/* ${LICHEE_BR_OUT}/target/lib/
...
sed -i '${/^$/d}' ${LICHEE_BR_OUT}/target/etc/profile
