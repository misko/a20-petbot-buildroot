...
GST1_PLUGINS_BAD_AUTORECONF_OPT = -I $(@D)/common/m4  -fi
...
GST1_PLUGINS_BAD_DEPENDENCIES = gst1-plugins-base gstreamer1  gettext libintl

#libintl host-gettext

GST1_PLUGINS_BAD_MAKE_OPT += CFLAGS+=-lintl
...
$(eval $(call AUTOTARGETS,package,gst1-plugins-bad))
