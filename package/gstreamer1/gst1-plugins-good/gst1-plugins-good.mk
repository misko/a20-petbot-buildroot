...
GST1_PLUGINS_GOOD_DEPENDENCIES = gstreamer1 gst1-plugins-base gettext libintl

#GST1_PLUGINS_GOOD_DEPENDENCIES = gstreamer1 gettext  libintl
GST1_PLUGINS_GOOD_MAKE_OPT += CFLAGS+=-lintl
...
$(eval $(call AUTOTARGETS,package,gst1-plugins-good))
