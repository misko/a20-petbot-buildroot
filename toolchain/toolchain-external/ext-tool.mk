...
USR_LIB_EXTERNAL_LIBS+=libstdc++.so libgcc_s.so
endif
...
else ifeq ($(BR2_TOOLCHAIN_EXTERNAL_CODESOURCERY_SUN7I),y)
TOOLCHAIN_EXTERNAL_SITE=http://www.codesourcery.com/sgpp/lite/superh/portal/package7783/public/sh-linux-gnu/
TOOLCHAIN_EXTERNAL_SOURCE=gcc-linarohf.tar.bz2
else
...
$(TOOLCHAIN_EXTERNAL_DIR)/.extracted: $(DL_DIR)/$(TOOLCHAIN_EXTERNAL_SOURCE)
	...
	#need to patch SPI here // MISKO
	#pushd $(TOOLCHAIN_EXTERNAL_DIR)
	#popd
#TRYING TO PATCH!!!!!! /home/vagrant/baidu/a20/lichee/buildroot /home/vagrant/baidu/a20/lichee/out/linux/common/buildroot/external-toolchain /home/vagrant/baidu/a20/lichee/out/linux/common/buildroot/external-toolchain XXX /home/vagrant/baidu/a20/lichee/out/linux/common/buildroot/build
	echo "TRYING TO PATCH!!!!!!" `pwd` $(@D) $(TOOLCHAIN_EXTERNAL_DIR) XXX  $(BUILD_DIR) $(STAGING_DIR) $(HOST_DIR)
	patch $(@D)/arm-linux-gnueabihf/libc/usr/include/linux/spi/spidev.h  toolchain/toolchain-external/toolchain-external-1-spi.patch
	$(Q)touch $@
...
$(STAMP_DIR)/ext-toolchain-installed: $(TOOLCHAIN_EXTERNAL_DEPENDENCIES)
	...
	for libs in $(USR_LIB_EXTERNAL_LIBS); do \
		echo "WTF WTF WTF WTF WTF $${ARCH_SYSROOT_DIR}/../"; \
		T=$${ARCH_SYSROOT_DIR} ; \
		$(call copy_toolchain_lib_root,$${T}/../,$$libs,/usr/lib); \
	done ; \
	touch $@
